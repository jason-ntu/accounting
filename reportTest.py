...
class TestReport(MockDB):
    ...
    def test_chooseInterval_with_valid_input(self, _chooseReportType, _hint_start_date, _hint_finish_date, _input, _stdout):
        ...
        self.assertEqual(_chooseReportType.call_count, 1)
    ...
    def test_chooseReportType(self, _Report, _hint_choose_report_type, _input, _stdout):
        result = ReportPage.chooseReportType('2023-01-01', '2023-04-30')
    ...
    def test_Report(self, _stdout):
        ...
        output_lines = _stdout.getvalue().strip().split('\n')
        self.assertEqual(output_lines[0], "\"BEVERAGE\" 金額總和:171 百分比:30%")
        self.assertEqual(output_lines[1], "\"FOOD\" 金額總和:408 百分比:70%")
        self.assertEqual(output_lines[2], "金額總和:579 百分比:100%")
        self.assertEqual(output_lines[3], "\"現金\" 金額總和:188 百分比:32%")
        self.assertEqual(output_lines[4], "\"信用卡\" 金額總和:321 百分比:55%")
        self.assertEqual(output_lines[5], "\"電子支付\" 金額總和:70 百分比:13%")
        self.assertEqual(output_lines[6], "金額總和:579 百分比:100%")
